      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 py-8 md:py-16 flex flex-col min-h-screen">
        ...
        <div className="mb-8 md:mb-16 flex items-center justify-between gap-3 flex-wrap">
          ...
          <div className="hidden sm:flex items-center gap-1.5 bg-slate-900/90 backdrop-blur-2xl px-3 py-1.5 rounded-xl shadow-2xl border-none">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest text-blue-400">Core OS v1.0.4</span>
          </div>
        </div>
        ...
        <div className="w-full aspect-[21/9] rounded-2xl overflow-hidden bg-slate-900/50 backdrop-blur-md shadow-2xl border-none mb-8 md:mb-12">
          <img
        ...
        <section className="grid md:grid-cols-12 gap-6 md:gap-8 items-start mb-12 md:mb-16">
          ...
          <div className="md:col-span-8 space-y-6 text-sm md:text-base text-slate-300 leading-relaxed font-normal">
            <p>
              <span className="float-left text-5xl md:text-6xl font-black text-blue-400 mr-3 mt-1 leading-none">W</span>
            ...
            <blockquote className="my-8 pl-6 border-l-4 border-blue-500/50 text-base md:text-lg font-bold text-slate-100 italic">
          ...
          <aside className="md:col-span-4 space-y-6 bg-slate-900/40 p-6 rounded-2xl backdrop-blur-md border-none shadow-xl">
            <h4 className="text-xs font-black uppercase tracking-widest text-blue-400">System Directives</h4>
            
            <ul className="space-y-6">
              <li className="flex gap-3">
                <Compass size={18} className="text-blue-400 flex-shrink-0 mt-0.5" />
        ...
        <footer className="mt-auto bg-gradient-to-r from-slate-900 to-blue-950/60 p-6 rounded-2xl shadow-2xl flex flex-col sm:flex-row items-center justify-between gap-4 border-none">
          <div className="space-y-1 text-center sm:text-left">
            <h4 className="text-xs font-black uppercase tracking-widest text-blue-400">Ready to initiate scan?</h4>
